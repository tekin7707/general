            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        user = { _id: '', email: this.email, password: this.password1 };
...
var AuthService = /** @class */ (function () {
    ...
    function AuthService(httpClient) {
        ...
        this.base_url = environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].SERVICE_BASE + '/user';
    ...
    AuthService.prototype.showNotification = function (type, message) {
        $.notify({
            icon: "notifications",
            message: message
        }, {
...
var environment = {
    ...
    SERVICE_BASE: 'https://lades-backend.herokuapp.com'
};
