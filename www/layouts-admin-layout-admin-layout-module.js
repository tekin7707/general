...
/* harmony import */ var app_services_lad_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/services/lad.service */ "./src/app/services/lad.service.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(route, ladService, authService) {
        this.route = route;
        this.ladService = ladService;
        this.authService = authService;
        this.loading = false;
        this.lads = [];
        this.summerize = { fiveLads: [], ladCount: 0, rating: 0 };
    }
    ...
    ;
    DashboardComponent.prototype.getMyPlayLads = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.getMyPlayLads()];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
    ...
    DashboardComponent.prototype.getSummerize = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.getSummerize()];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            app_services_lad_service__WEBPACK_IMPORTED_MODULE_3__["LadService"],
...
/***/ "./src/app/lad/lad-action/lad-action.component.html":
/*!**********************************************************!*\
  !*** ./src/app/lad/lad-action/lad-action.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container-fluid loading-div\" *ngIf=\"loading\">\n  <div class=\"row\">\n    <div class=\"col-md-12 loading-bar\">\n      <mat-progress-bar mode=\"query\"></mat-progress-bar>\n    </div>\n  </div>\n</div>\n<div class=\"main-content\" *ngIf=\"!loading\">\n  <div class=\"container-fluid\">\n    <div class=\"row\">\n      <div class=\"col-md-12\">\n        <div class=\"card\">\n          <div class=\"card-header card-header-warning\">\n            <h4 class=\"card-title\">{{ladAll.lad.caption}} (Price : {{ladAll.lad.ladValue}})</h4>\n            <p class=\"card-category\">min-max ({{ladAll.lad.oneLadMin}} - {{ladAll.lad.oneLadMax}})\n              / Date ({{ladAll.lad.startDate|date:'dd/MM/yyyy'}} - {{ladAll.lad.endDate|date:'dd/MM/yyyy'}})\n            </p>\n          </div>\n          <div class=\"card-body\">\n            <div class=\"tab-content\">\n              <div class=\"tab-pane active\" id=\"profile\">\n                <table class=\"table\">\n                  <tbody>\n                    <tr *ngFor=\"let _ladItem of ladAll.ladItems\">\n                      <td>\n                        <div class=\"form-check\">\n                          <label class=\"form-check-label\">\n                            <input class=\"form-check-input\" type=\"checkbox\" name=\"selected\" [(ngModel)]=\"_ladItem.selected\">\n                            <span class=\"form-check-sign\">\n                              <span class=\"check\"></span>\n                            </span>\n                          </label>\n                        </div>\n                      </td>\n                      <td>{{_ladItem.caption}}</td>\n                      <td>{{_ladItem.ladValue}} (max: {{ladAll.lad.oneLadMax}})</td>\n                    </tr>\n                  </tbody>\n                  <tfoot>\n                    <tr>\n                      <td colspan=\"2\">\n                        <mat-form-field class=\"example-full-width pull-right text-right\">\n                          <input id=\"ladActionValue\" [(ngModel)]=\"ladAction.actionValue\" name=\"ladActionValue\" matInput placeholder=\"Value\"\n                            type=\"text\">\n                        </mat-form-field>\n                      </td>\n                      <td>\n                        <button mat-raised-button type=\"button\" (click)=\"play()\" class=\"btn btn-danger pull-right\">Select</button>\n                      </td>\n                    </tr>\n                  </tfoot>\n                </table>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/lad/lad-action/lad-action.component.scss":
/*!**********************************************************!*\
  !*** ./src/app/lad/lad-action/lad-action.component.scss ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/lad/lad-action/lad-action.component.ts":
/*!********************************************************!*\
  !*** ./src/app/lad/lad-action/lad-action.component.ts ***!
  \********************************************************/
/*! exports provided: LadActionComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LadActionComponent", function() { return LadActionComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var app_services_lad_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/services/lad.service */ "./src/app/services/lad.service.ts");
...
var LadActionComponent = /** @class */ (function () {
    function LadActionComponent(dateAdapter, route, router, ladService, authService) {
        var _this = this;
        ...
        this.route.params.subscribe(function (params) {
            _this.id = params["id"];
            console.log('%s ', _this.id);
        });
    }
    LadActionComponent.prototype.ngOnInit = function () {
        this.user = this.authService.getLoginUser();
        this.getLad();
    };
    LadActionComponent.prototype.getLad = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.getLadForAction(this.id)];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
                            this.ladAll = r.data.data;
                            this.ladAll.ladItems.forEach(function (element) {
    ...
    LadActionComponent.prototype.insertLadAction = function (_ladItem) {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ladService.insertLadAction(this.ladAction)];
                    case 1:
                        r = _a.sent();
    ...
    LadActionComponent.prototype.play = function () {
        var li = this.ladAll.ladItems.findIndex(function (x) { return x.selected; });
        if (li > -1) {
    ...
    LadActionComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-lad-action',
            template: __webpack_require__(/*! ./lad-action.component.html */ "./src/app/lad/lad-action/lad-action.component.html"),
            styles: [__webpack_require__(/*! ./lad-action.component.scss */ "./src/app/lad/lad-action/lad-action.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_4__["DateAdapter"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            app_services_lad_service__WEBPACK_IMPORTED_MODULE_2__["LadService"],
            app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])
    ], LadActionComponent);
    return LadActionComponent;
}());
...
/***/ "./src/app/lad/lad-detail/lad-detail.component.html":
/*!**********************************************************!*\
  !*** ./src/app/lad/lad-detail/lad-detail.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/lad/lad-detail/lad-detail.component.scss":
/*!**********************************************************!*\
  !*** ./src/app/lad/lad-detail/lad-detail.component.scss ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/lad/lad-detail/lad-detail.component.ts":
/*!********************************************************!*\
  !*** ./src/app/lad/lad-detail/lad-detail.component.ts ***!
  \********************************************************/
/*! exports provided: LadDetailComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LadDetailComponent", function() { return LadDetailComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var app_services_lad_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/services/lad.service */ "./src/app/services/lad.service.ts");
/* harmony import */ var app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/services/auth.service */ "./src/app/services/auth.service.ts");
...
var LadDetailComponent = /** @class */ (function () {
    function LadDetailComponent(dateAdapter, route, router, ladService, authService) {
        var _this = this;
        this.dateAdapter = dateAdapter;
        this.route = route;
        this.router = router;
        ...
        this.id = '';
        this.ladItem = { _id: '', masterId: '', name: '', caption: '', rate: 1, state: 1, selected: false };
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.id = params["recId"];
            if (_this.mode == 'insert') {
                _this.islemCaption = "New Record";
            }
            else {
                _this.id = params["id"];
                _this.islemCaption = _this.mode == 'del' ? "Kayıt Silinecek !" : "Kayıt Düzenle";
            }
            console.log('%s : %s', _this.mode, _this.id);
        });
        console.log('%c <-- lad-detail constructor', 'color:orange;');
    }
    LadDetailComponent.prototype.ngOnInit = function () {
        this.user = this.authService.getLoginUser();
        this.ladAll.lad.userId = this.user._id;
        if (this.mode == 'browse' || this.mode == 'edit' || this.mode == 'delete')
            this.getLad();
        console.log(this.ladAll);
    };
    LadDetailComponent.prototype.getLad = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.getLad(this.id)];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
                            this.ladAll = r.data.data;
    ...
    LadDetailComponent.prototype.reset = function () {
        window.history.back();
    };
    LadDetailComponent.prototype.run = function () {
        if (this.mode == 'insert') {
            this.insertLad();
        }
    ...
    LadDetailComponent.prototype.insertLad = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ladService.insertLad(this.ladAll.lad)];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200 || r.status == 201) {
    ...
    LadDetailComponent.prototype.updateLad = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.updateLad(this.ladAll.lad)];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
    ...
    LadDetailComponent.prototype.deleteLad = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.deleteLad(this.ladAll.lad._id)];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
    ...
    LadDetailComponent.prototype.prepareLadItemEdit = function (_ladItem) {
        this.loading = true;
        this.ladItemMode = 'edit';
        this.ladItem = _ladItem;
        this.loading = false;
    };
    LadDetailComponent.prototype.prepareLadItemDelete = function (_ladItem) {
        this.ladItemMode = 'delete';
        this.ladItem = _ladItem;
    };
    LadDetailComponent.prototype.prepareLadItemInsert = function (_ladItem) {
        this.ladItemMode = 'insert';
        this.ladItem = { masterId: this.ladAll.lad._id, _id: '', name: '', caption: '', rate: 1, state: 0, selected: false };
        console.log(this.ladItem);
        console.log(this.ladAll);
    };
    LadDetailComponent.prototype.resetItem = function () {
        this.ladItem = { _id: '', masterId: '', name: '', caption: '', rate: 1, state: 0, selected: false };
        this.ladItemMode = 'browse';
    };
    LadDetailComponent.prototype.runItem = function () {
    ...
    LadDetailComponent.prototype.insertLadItem = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.insertLadItem(this.ladItem)];
                    case 1:
                        r = _a.sent();
                        if (!(r.status == 200 || r.status == 201)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.getLad()];
                    case 2:
                        _a.sent();
    ...
    LadDetailComponent.prototype.updateLadItem = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.updateLadItem(this.ladItem)];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
    ...
    LadDetailComponent.prototype.deleteLadItem = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r, lii;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.deleteLadItem(this.ladItem._id)];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
                            console.log('deleteLadItem %c Deleted Data -->', 'color:green;');
                            console.log(r);
                            lii = this.ladAll.ladItems.findIndex(function (x) { return x._id == _this.ladItem._id; });
                            if (lii > -1) {
    ...
    LadDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-lad-detail',
            template: __webpack_require__(/*! ./lad-detail.component.html */ "./src/app/lad/lad-detail/lad-detail.component.html"),
            styles: [__webpack_require__(/*! ./lad-detail.component.scss */ "./src/app/lad/lad-detail/lad-detail.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_4__["DateAdapter"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
...
/***/ "./src/app/lad/lad-list/lad-list.component.html":
/*!******************************************************!*\
  !*** ./src/app/lad/lad-list/lad-list.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container-fluid loading-div\" *ngIf=\"loading\">\n    <div class=\"row\">\n        <div class=\"col-md-12 loading-bar\">\n            <mat-progress-bar mode=\"query\"></mat-progress-bar>\n        </div>\n    </div>\n</div>\n<div class=\"main-content\" *ngIf=\"!loading\">\n    <div class=\"container-fluid\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <div class=\"card card-plain\">\n                    <div class=\"card-header card-header-danger\">\n                        <h4 class=\"card-title mt-0\"> </h4>\n                        <p class=\"card-category\"> Lad Listeniz</p>\n                    </div>\n                    <div class=\"card-body\">\n                        <div class=\"table-responsive\">\n                            <table class=\"table table-hover\">\n                                <thead class=\"\">\n                                    <th>\n                                        Caption\n                                    </th>\n                                    <th>\n                                        Value\n                                    </th>\n                                    <th>\n                                        Dates\n                                    </th>\n                                    <th>\n                                        <i class=\"material-icons icon-button pull-right color-red\" routerLink=\"../lad-detail/insert/0\">add</i>\n                                    </th>\n                                </thead>\n                                <tbody>\n                                    <tr *ngFor=\"let lad of lads\" routerLink=\"../lad-detail/browse/{{lad._id}}\">\n                                        <td>\n                                            {{lad.caption}}\n                                        </td>\n                                        <td>\n                                            {{lad.ladValue}}\n                                        </td>\n                                        <td>\n                                            {{lad.startDate|date:'dd/MM/yyyy'}}\n                                            -\n                                            {{lad.endDate|date:'dd/MM/yyyy'}}\n                                        </td>\n                                        <td class=\"text-right\">\n                                            <i class=\"material-icons icon-button\" routerLink=\"../lad-detail/edit/{{lad._id}}\">code</i>\n                                            &nbsp;\n                                            <i class=\"material-icons icon-button-del\" routerLink=\"./../lad-detail/delete/{{lad._id}}\">delete</i>\n                                        </td>\n                                    </tr>\n                                </tbody>\n                            </table>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>"

/***/ }),

/***/ "./src/app/lad/lad-list/lad-list.component.scss":
/*!******************************************************!*\
  !*** ./src/app/lad/lad-list/lad-list.component.scss ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./src/app/lad/lad-list/lad-list.component.ts":
/*!****************************************************!*\
  !*** ./src/app/lad/lad-list/lad-list.component.ts ***!
  \****************************************************/
/*! exports provided: LadListComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LadListComponent", function() { return LadListComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var app_services_lad_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/services/lad.service */ "./src/app/services/lad.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/services/auth.service */ "./src/app/services/auth.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var LadListComponent = /** @class */ (function () {
    function LadListComponent(route, ladService, authService) {
        this.route = route;
        this.ladService = ladService;
        this.authService = authService;
        this.loading = false;
    ...
    LadListComponent.prototype.ngOnInit = function () {
        this.user = this.authService.getLoginUser();
        this.getMyLads();
    };
    LadListComponent.prototype.showNotification = function (type, message) {
        $.notify({
            icon: "notifications",
            message: message
        }, {
    ...
    LadListComponent.prototype.getMyLads = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.ladService.getMyLads()];
                    case 1:
                        r = _a.sent();
                        if (r.status == 200) {
    ...
    LadListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-lad-list',
            template: __webpack_require__(/*! ./lad-list.component.html */ "./src/app/lad/lad-list/lad-list.component.html"),
            styles: [__webpack_require__(/*! ./lad-list.component.scss */ "./src/app/lad/lad-list/lad-list.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            app_services_lad_service__WEBPACK_IMPORTED_MODULE_1__["LadService"],
            app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])
    ], LadListComponent);
    return LadListComponent;
}());
...
/* harmony import */ var app_lad_lad_list_lad_list_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! app/lad/lad-list/lad-list.component */ "./src/app/lad/lad-list/lad-list.component.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var app_lad_lad_detail_lad_detail_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! app/lad/lad-detail/lad-detail.component */ "./src/app/lad/lad-detail/lad-detail.component.ts");
/* harmony import */ var app_lad_lad_action_lad_action_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! app/lad/lad-action/lad-action.component */ "./src/app/lad/lad-action/lad-action.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AdminLayoutModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                app_lad_lad_list_lad_list_component__WEBPACK_IMPORTED_MODULE_13__["LadListComponent"],
                app_lad_lad_detail_lad_detail_component__WEBPACK_IMPORTED_MODULE_15__["LadDetailComponent"],
                app_lad_lad_action_lad_action_component__WEBPACK_IMPORTED_MODULE_16__["LadActionComponent"]
            ]
        })
    ], AdminLayoutModule);
...
/* harmony import */ var app_lad_lad_list_lad_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! app/lad/lad-list/lad-list.component */ "./src/app/lad/lad-list/lad-list.component.ts");
/* harmony import */ var app_lad_lad_detail_lad_detail_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! app/lad/lad-detail/lad-detail.component */ "./src/app/lad/lad-detail/lad-detail.component.ts");
/* harmony import */ var app_lad_lad_action_lad_action_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! app/lad/lad-action/lad-action.component */ "./src/app/lad/lad-action/lad-action.component.ts");
...
var AdminLayoutRoutes = [
    ...
    { path: 'ladlist', component: app_lad_lad_list_lad_list_component__WEBPACK_IMPORTED_MODULE_9__["LadListComponent"], canActivate: [app_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: 'lad-detail/:mode/:id', component: app_lad_lad_detail_lad_detail_component__WEBPACK_IMPORTED_MODULE_10__["LadDetailComponent"], canActivate: [app_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: 'lad-action/:id', component: app_lad_lad_action_lad_action_component__WEBPACK_IMPORTED_MODULE_11__["LadActionComponent"], canActivate: [app_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
];
...
/***/ "./src/app/services/lad.service.ts":
/*!*****************************************!*\
  !*** ./src/app/services/lad.service.ts ***!
  \*****************************************/
/*! exports provided: LadService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LadService", function() { return LadService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var LadService = /** @class */ (function () {
    // base_url = 'http://localhost:5001/lad';
    function LadService(httpClient) {
        this.httpClient = httpClient;
        this.base_url = 'https://lades-backend.herokuapp.com/lad';
        this.base_url = environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].SERVICE_BASE + '/lad';
        console.log('Base Service: ', this.base_url);
    }
    LadService.prototype.getMyPlayLads = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.httpClient.get(this.base_url + '/getMyPlayActions').toPromise()
                                .then(function (d) {
                                r.data = d;
                                console.log(d);
                            })
    ...
    LadService.prototype.getMyLads = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        r = { status: 200, message: '' };
                        return [4 /*yield*/, this.httpClient.get(this.base_url + '/getAllLads').toPromise()
                                .then(function (d) {
                                r.data = d;
                                console.log(d);
                            })
    ...
    LadService.prototype.getLad = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var r, header;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.httpClient.get(this.base_url + '/getLad', {
                                headers: header,
                                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('_id', id)
                            }).toPromise()
                                .then(function (d) {
                                r.data = d;
                                console.log(d);
    ...
    LadService.prototype.getLadForAction = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var r, header;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        r = { status: 200, message: '' };
                        header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
                        return [4 /*yield*/, this.httpClient.get(this.base_url + '/getLadForPage', {
    ...
    LadService.prototype.getSummerize = function () {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        r = { status: 200, message: '' };
                        return [4 /*yield*/, this.httpClient.get(this.base_url + '/getSummerize').toPromise()
                                .then(function (d) {
                                r.data = d;
                                console.log(d);
                            })
    ...
    LadService.prototype.insertLadAction = function (ladAction) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('insertLadAction');
                        r = { status: 0, message: '' };
                        url = this.base_url + '/addLadAction';
                        console.log(url);
                        console.log(ladAction);
                        return [4 /*yield*/, this.httpClient.post(url, ladAction).toPromise().then(function (d) {
                                console.log(d);
                                r = d;
                                console.log(r.data);
                            }).catch(function (err) {
    ...
    LadService.prototype.insertLad = function (lad) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('insertLad');
                        r = { status: 0, message: '' };
                        url = this.base_url + '/addLad';
                        console.log(url);
                        console.log(lad);
                        return [4 /*yield*/, this.httpClient.post(url, lad).toPromise().then(function (d) {
                                console.log(d);
                                r = d;
                                console.log(r.data);
                            }).catch(function (err) {
    ...
    LadService.prototype.updateLad = function (lad) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LadService.prototype.deleteLad = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LadService.prototype.insertLadItem = function (ladItem) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('insertLadItem');
                        r = { status: 0, message: '' };
                        url = this.base_url + '/addLadItem';
                        console.log(url);
                        console.log(ladItem);
                        return [4 /*yield*/, this.httpClient.post(url, ladItem).toPromise().then(function (d) {
                                console.log(d);
                                r = d;
                                console.log(r.data);
                            }).catch(function (err) {
    ...
    LadService.prototype.updateLadItem = function (ladItem) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('updateLadItem');
                        r = { status: 0, message: '' };
                        url = this.base_url + '/updateLadItem';
                        console.log(url);
                        console.log(ladItem);
                        return [4 /*yield*/, this.httpClient.post(url, ladItem).toPromise().then(function (d) {
                                console.log(d);
    ...
    LadService.prototype.deleteLadItem = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('deleteLadItem');
                        r = { status: 0, message: '' };
                        url = this.base_url + '/deleteLadItem';
                        console.log(url);
                        return [4 /*yield*/, this.httpClient.delete(url, {
                                params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('_id', id)
                            }).toPromise().then(function (d) {
